...
const plans = [
  {
    ...
    features: ['2 Premium accounts', 'Ad-free music', 'Offline downloads', 'On-demand playback', 'M-Pesa billing'],
    popular: false,
  },
  {
    name: 'Spotify Family',
    ...
    features: ['6 Premium accounts', 'Ad-free music', 'Offline downloads', 'On-demand playback', 'M-Pesa billing', 'Individual account per member', 'Managed by Bundivo'],
    popular: true,
  },
]
